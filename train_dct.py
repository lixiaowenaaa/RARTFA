...
import itertools
from symbols import resnet_dct, resnet_svhn
...
if __name__ == '__main__':
    ...
    # Configure save root
    img_saveroot = './models/bpgd/cifar10/vis/dc_img/'
    model_saveroot = './models/bpgd/cifar10/vis/'

    device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
    modelC = resnet_dct.ResNet18().to(device)
